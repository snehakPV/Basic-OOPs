...
namespace EBBill
{
    public class Operations
    {
        ...
        public static List<EBMeterDetails> entryList=new List<EBMeterDetails>();
        ...
        public void Default()
        {
            userList.Add(new UserDetails("Ravi","858585232","Theni"));
            userList.Add(new UserDetails("Baskaran","3456789","Chennai"));

            entryList.Add(new EBMeterDetails(userList[0].CustomerID,40,MeterType.Domestic,"March-2023"));
            entryList.Add(new EBMeterDetails(userList[1].CustomerID,70,MeterType.Domestic,"March-2023"));
